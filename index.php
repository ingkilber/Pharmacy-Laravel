        ...
        <?php echo (isset($alert)) ? $alert : '' ; ?>
							<div class="card">
								<div class="card-header card-header-primary text-center">
									...
									<img src="assets/img/kilber.png" width="150"/>
								</div>
								<div class="card-body">
									<?php echo isset($alert) ? $alert : ''; ?>
									<form action="" method="post" class="p-3">
										...
										<div class="mt-3">
											<button class="btn btn-block btn-dark btn-lg font-weight-medium auth-form-btn" type="submit">Acceder</button>
										</div>

                                        <div class="mt-3">
                                        <h4 class="text-center">User: kilber / Pass: 123456</h4>
										</div>
